...
class NewBookPage extends StatefulWidget {
  ...
  @override State<NewBookPage> createState() => _NewBookPageState();
}
...
class _NewBookPageState extends State<NewBookPage> {
  ...
  bool _isSuspenseFavorite = false,
      _isTerrorFavorite = false;
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: const Text('Nuevo Libro'),),
      body: Padding(
        ...
        child: SingleChildScrollView(child: Column(
          ...
          children: [
            Container(decoration: const BoxDecoration(color: Colors.white),
              ...
              child: Stack(children: [
                ...
                Positioned(bottom: 0,
                  right: 0,
                  child: IconButton(
                    alignment: Alignment.bottomLeft, onPressed: () async {
                    pickImage();
            ...
            const SizedBox(height: 16.0,),
            TextFormField(controller: _author,
              decoration: const InputDecoration(
                  border: OutlineInputBorder(), labelText: 'Autor'),
              keyboardType: TextInputType.text,),
            const SizedBox(height: 16.0,),
            TextFormField(controller: _pages,
              decoration: const InputDecoration(
            ...
            const SizedBox(height: 16.0,),
            const Text('Género(s) del libro', style: TextStyle(fontSize: 20),),
            const SizedBox(height: 16.0,),
            Row(children: [
              Expanded(child: CheckboxListTile(title: const Text('Acción'),
              ...
              Expanded(child: CheckboxListTile(title: const Text('Aventura'),
            ...
            Row(children: [
              Expanded(child: CheckboxListTile(title: const Text('Drama'),
              ...
              Expanded(child: CheckboxListTile(title: const Text('Fantasia'),
            ...
            Row(children: [
              Expanded(child: CheckboxListTile(title: const Text('Ficción'),
              ...
              Expanded(child: CheckboxListTile(title: const Text('Romance'),
            ...
            Row(children: [
              Expanded(child: CheckboxListTile(title: const Text('Suspenso'),
              ...
              Expanded(child: CheckboxListTile(title: const Text('Terror'),
